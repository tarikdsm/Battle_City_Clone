...
**Status:** in development — **core simulation complete** (211 tests, all 26 NES-parity invariants covered, three golden replays, 2.11 µs per simulation step). Rendering is next. Live progress: [implementation plan](docs/06-implementation-plan.md) · [execution status](docs/07-execution-status.md).
